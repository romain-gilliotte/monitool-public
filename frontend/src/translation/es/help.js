module.exports = {
    pages: {
        ...
        basics: {
            ...
            paragraph: "<p>Los datos básicos permiten clasificar su proyecto entre los demas de la ONG.</p>"
        },
        sites: {
        ...
        history: {
            title: `Historique`,
            paragraph: "El historial de modificaciones le permite consultar todos los cambios hechos en la estructura de su proyecto."
        },
        input_list: {
