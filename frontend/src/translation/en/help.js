...
<div class="alert alert-info">
    <i class="fa fa-info-circle"></i>
        ...
        By avoiding acronyms you improve the readability of your charts and tables and allow a better understanding
        of your project by all actors of Doctors of the World.
    </div>
    ...
    <div class="alert alert-info">
        ...
        <a class="btn btn-default btn-xs" ui-sref="project.structure.history" disable-if="!$ctrl.project._id">
