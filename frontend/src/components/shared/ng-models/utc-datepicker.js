...
module.component(__componentName, {
    ...
    controller: class {
        $onChanges() {
            ...
            if (this.minMode) this.datePickerOptions.minMode = this.minMode;
            if (this.minDate) this.datePickerOptions.minDate = this._modelToView(this.minDate);
            if (this.maxDate) this.datePickerOptions.maxDate = this._modelToView(this.maxDate);
        }
        ...
        _modelToView(modelValue) {
            ...
            modelValue = new Date(
                modelValue.getTime() + modelValue.getTimezoneOffset() * 60 * 1000
            );
            return modelValue;
        }
