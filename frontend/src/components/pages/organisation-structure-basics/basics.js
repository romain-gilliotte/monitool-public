...
const module = angular.module(
	'monitool.components.pages.organisation.structure.basics',
	[
...
module.config($stateProvider => {
	$stateProvider.state('main.organisation.structure.basics', {
		acceptedUsers: ['loggedIn'],
		url: '/basics',
		component: 'organisationBasics'
	});
});


module.component('organisationBasics', {
	bindings: {
	...
	controller: class OrganisationBasicsController {
